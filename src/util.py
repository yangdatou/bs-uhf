...
def solve_bs_noci(r, basis="sto-3g", m="h2", is_scf=False):
    ...
    ene_noci_ump2_2, vfci_noci_ump2_2  = solve_ump2_noci(v_bs_ump2_list, hv_bs_ump2_list, v_bs_uhf_list=v_bs_uhf_list, ene_ump2_list=ene_bs_ump2_list, tol=1e-4, method=2, ref=ene_fci)
